  ...
  <ul class="breadcrumb">
	...
	<li class="dropdown" style="float:right">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="../common/user.html"><%=request.getAttribute("username") %>>
			...
			<table class="table">
				...
				<%int i = 0; %>
						...
						<tr>
							...
							<td><a href="javascript:document.reqForm.submit();" onclick="return setValue('<s:property value="#clist.id" />');"><s:property value="#clist.cname" /></a></td>
