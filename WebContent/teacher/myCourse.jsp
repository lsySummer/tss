...
<body data-spy="scroll" data-target="#myScrollspy">
	<div class="container">
		...
		<div class="row">
			...
			%>
			<div class="col-xs-9">
				<s:form action="/teacher/course" method="post" name="reqForm">
							...
							<tbody>
								...
								<s:iterator value="#carr" id='clist'>
									<tr>
										...
										<td><a href="javascript:document.reqForm.submit();"
											onclick="return setValue('<s:property value="#clist.id" />');"><s:property
													value="#clist.cname" /></a></td>

										<td><input type="hidden" id=<%="startdate" + i + "_" + k%>
											value='<s:property value="#clist.startDate" />' /> <input
											type="hidden" id=<%="enddate" + i + "_" + k%>
											value='<s:property value="#clist.endDate" />' /> <input
											type="text" id=<%="st" + i + "_" + k%> style="border: 0;" readonly />
										</td>
									</tr>
